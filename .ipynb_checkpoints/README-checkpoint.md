...
look at the Titanic manifest. We'll be exploring this data to see what we can learn regarding the survival rates of different groups of people.

## Prework

## Step 1: Reading the data
1. Go to [https://www.kaggle.com/c/titanic/data](https://www.kaggle.com/c/titanic/data)
2. Familiarize yourself with data dictionary explaining each of the columns.
...
Basic charts (Gender, Age, etc), then look for something beneath the surface.
